      ...
      for (e = this.options.pedantic ? e.replace(/\t/g, '    ').replace(/^ +$/gm, '') : e.replace(/^( *)(\t+)/gm, (e, t, n) => t + '    '.repeat(n.length)); e; )
        if (
          !(
            ...
            this.options.extensions.block.some((s) => !!(n = s.call({ lexer: this }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0))
          )
        )
          if ((n = this.tokenizer.space(e))) (e = e.substring(n.raw.length)), 1 === n.raw.length && t.length > 0 ? (t[t.length - 1].raw += '\n') : t.push(n);
            ...
            if (this.state.top && (n = this.tokenizer.paragraph(r)))
              (s = t[t.length - 1]),
                i && 'paragraph' === s.type
                  ? ((s.raw += '\n' + n.raw), (s.text += '\n' + n.text), this.inlineQueue.pop(), (this.inlineQueue[this.inlineQueue.length - 1].src = s.text))
                  : t.push(n),
                (i = r.length !== e.length),
                (e = e.substring(n.raw.length));
        ...
        if (e.length > 0)
          for (; null != (i = this.tokenizer.rules.inline.reflinkSearch.exec(a)); )
            e.includes(i[0].slice(i[0].lastIndexOf('[') + 1, -1)) &&
              (a = a.slice(0, i.index) + '[' + 'a'.repeat(i[0].length - 2) + ']' + a.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex));
      }
      ...
      for (; e; )
        if (
          ...
          !(
            ...
            this.options.extensions.inline.some((s) => !!(n = s.call({ lexer: this }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0))
          ))
        )
          if ((n = this.tokenizer.escape(e))) (e = e.substring(n.raw.length)), t.push(n);
          else if ((n = this.tokenizer.tag(e)))
            (e = e.substring(n.raw.length)), (s = t[t.length - 1]), s && 'text' === n.type && 'text' === s.type ? ((s.raw += n.raw), (s.text += n.text)) : t.push(n);
                  ...
                  ? n.tokens.length > 0 && 'paragraph' === n.tokens[0].type
                    ? ((n.tokens[0].text = e + ' ' + n.tokens[0].text),
                      n.tokens[0].tokens &&
                        ...
                        (n.tokens[0].tokens[0].text = e + ' ' + n.tokens[0].tokens[0].text))
    ...
    #e(e, t) {
      return (n, s) => {
        ...
        !0 === this.defaults.async &&
          !1 === r.async &&
          (i.silent || console.warn('marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored.'), (i.async = !0));
